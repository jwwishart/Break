...
- If the computer is idle for a given amount of time the system will reset
  the timer and start counting from when you start using the computer again.
  The break duration can be set in the preferences
